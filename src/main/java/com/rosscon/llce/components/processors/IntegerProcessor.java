...
public abstract class IntegerProcessor implements ClockListener  {
     ...
     */
    public IntegerProcessor (Clock clock, IntegerBus addressBus, IntegerBus dataBus, Flag rwFlag){
        this.clock = clock;
