...
public class MOS6502TestPHP {
    ...
    public void testPHPPushesAValueToTheStack() throws MemoryException, ClockException, InvalidBusDataException {
        ...
        clock.tick(5);
        assertEquals((byte)0b00110001, dataBus.readDataFromBus()[0]);
        assertEquals((byte)0b00000001, cpu.getRegStatus());
    }
}
